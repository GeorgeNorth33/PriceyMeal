...
INSERT INTO `UserPreferences` (`id`, `user_id`, `interests`, `created_at`, `updated_at`) VALUES
(13, 1, 'Молочные продукты, свежие овощи, качественное мясо', '2025-11-29 11:47:40', '2025-11-29 11:47:40');
...
--
-- Дамп данных таблицы `UserRecommendations`
--

INSERT INTO `UserRecommendations` (`id`, `user_id`, `product_id`, `reason`, `ranking`, `created_at`) VALUES
(1, 1, 6, NULL, 8, '2025-11-29 11:48:52');
...
(1, 'Иван', 'Иванов', 'ivanov@mail.ru', '12345678', '88005553536', 'М', '1995-11-01'),
...
--
-- Дамп данных таблицы `UserViewHistory`
--

INSERT INTO `UserViewHistory` (`id`, `user_id`, `product_id`, `viewed_at`) VALUES
(7, 1, 2, '2025-11-29 11:48:23'),
(8, 1, 3, '2025-11-29 11:48:23');
...
--
ALTER TABLE `Product Store`
  MODIFY `id_product_store` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=345;
